...
This repository is a **full working fork** of upstream `caddyserver/caddy` (real upstream tree on both `main` and `unicore`), created 2026-07-07 and enrolled in the UniCORE upstream-merge cron fleet on 2026-07-09.

- `main` mirrors upstream at `13a4c3f4` (advances via the periodic upstream-merge cron).
